...
<ul>
  ...
  <li>📊 <a href="https://github.com/sujal-sadh/blinkit-sales-analysis-excel-sql-powerbi/blob/master/dashboard/Blinkit_Dashboard.pbix" target="_blank">Power BI File (.pbix)</a></li>
  <li>🧮 <a href="https://github.com/sujal-sadh/blinkit-sales-analysis-excel-sql-powerbi/blob/master/sql_script/sql_script.sql" target="_blank">SQL Script</a></li>
